...
UtalCanvasPlainRectangle* UtalCanvasUtilsFixRectangle( int x1, int y1, int x2, int y2 )
{
    ...
    UtalCanvasPlainRectangle* rectangle = (UtalCanvasPlainRectangle*)malloc(sizeof(UtalCanvasPlainRectangle));
    rectangle->x = x;
    rectangle->y = y;
