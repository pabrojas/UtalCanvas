...
extern "C" {
    ...
    /**
     * Reproduce un audio en formato wav o mp3 y retorna su identificador. Como 
     * restriccion hay que tener en cuenta que UtalCanvas fue configurado para 
     * reproducir un maximo de 32 audios de forma paralela.
     * 
     * @param filename archivo de audio a reproducir. Debe tener formato wav o mp3.
     * @param loops la cantidad de veces que se repetira. Si se especifica 0 se reproducira
     *          pero no se repetira. Si se especifica -1 se repetira cotinuamente.
     * @return el identificador del audio que se encuentra reproduciendo.
     */
    int play_audio(char filename[PATHNAME_LENGTH], int loops);
    
    /**
     * Pausa un audio que se este reproduciendo segun su identificador. 
     * 
     * @param id identificador del audio que se desea pausar. Si se especifica -1
     *          se pausaran todos los audios que se encuentren reproduciendose.
     */
    void pause_audio(int id);
    
    /**
     * Restaura la reproduccion de un audio segun su identificador.
     * 
     * @param id identificador del audio que se desea restaurar. Si se especifica -1
     *          se restauraran todos los audios que se encuentren pausados.
     */
    void resume_audio(int id);
    
    /**
     * Detiene la reproduccion de un audio segun su identificador.
     * 
     * @param id identificador del audio que se desea detener. Si se especifica -1
     *          se detendram todos los audios que se encuentren reproduciendose y pausados.
     */
